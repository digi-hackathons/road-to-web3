        ...
        <div className="welcome">
            ...
            <div className="selections">
                <div className="select">
                    ...
                    <ul>
                        <li>
                            <div className="item"><img src="/images/usa.png"/>English</div>
                        </li>
                        <li>
                            <div className="item"><img src="/images/japan.png"/>Japonese</div>
                        </li>
                        <li>
                            <div className="item"><img src="/images/brazil.png"/>Portuguese</div>
                        </li>
                    </ul>
                </div>
